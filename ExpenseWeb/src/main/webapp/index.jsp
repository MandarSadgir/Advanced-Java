...
%>
    ...
    <div class="container-fluid">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid">
                <a class="navbar-brand fw-bold fs-3 "  href="#">Expense Manager</a>
    ...
    <div class="row mt-3 ms-3">
        ...
        <div class="col">
           ...
           <%  %>
                <div class="card-body text-center">
                  <h5 class="card-title">Spend On Shopping</h5>
        ...
        <div class="col">
            ...
            <div class="card text-black  mb-3" style="max-width: 18rem; background-color:rgba(81,205,160,0.6)">
                ...
                <div class="card-body text-center">
                  <h5 class="card-title">Spend On food</h5>
         ...
         <div class="col">
           ...
           <%  %>
                <div class="card-body text-center">
                  <h5 class="card-title">Spend On Medical</h5>
    ...
    <div class="row" style="height: 75vh;">
       ...
       <!--   <div class="col-6 bg-light border">
        ...
        <div class="class=col-6 bg-light  " style="height:400px;width:49vw;">
